...
st.set_page_config(page_title="DKT Dashboard", page_icon="🌍", layout="wide")
st.header(":bar_chart: DKT Dashboard")
st.markdown('<style>div.block-container{padding-top:2rem;}</style>', unsafe_allow_html=True)

# URL de l'API et clé d'authentification
api_url = "https://kf.kobotoolbox.org/api/v2/assets/aQ22QWK6VizgZUAma6vvFU/data/?format=json"
headers = {
